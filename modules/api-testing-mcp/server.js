...
export function createMCPHttpApp() {
  ...
  // Mount REST API routes for the UI
  ...
  app.get('/health', (req, res) => {
    res.json({
      status: 'healthy',
      service: 'API Testing MCP Server',
      version: '1.0.0',
      database: 'connected',
      tools: 8, // Total number of tools
  ...
  app.get('/info', (req, res) => {
    res.json({
      ...
      version: '1.0.0',
      description: 'MCP server for API testing with AI-powered analysis',
      endpoints: {
        sse: '/mcp/sse',
        health: '/mcp/health',
        info: '/mcp/info'
      ...
      tools: [
        { name: 'test-api', description: 'Test API with multiple scenarios and generate AI analysis' },
        { name: 'get-api', description: 'Get API by ID' },
        { name: 'list-apis', description: 'List all registered APIs' },
        { name: 'get-test-results', description: 'Get test results for an API' },
        { name: 'get-api-statistics', description: 'Get API statistics' },
        { name: 'generate-test-scenarios', description: 'Auto-generate test scenarios' },
        { name: 'query-api-with-summary', description: 'Execute API call and return response with AI-generated summary' },
        { name: 'validate-and-execute-api', description: 'Validate request parameters and execute API call' }
      ],
      features: [
        'Test APIs with multiple scenarios',
        'AI-powered test result analysis',
        'MySQL database for API storage',
